...
a random background is added. In \textit{bg-img}, each image is given a background
...
>>>>>>> 0f597c818459f31170b2fa0fe64efcef7df3f5b7
...
a test set for both the encoded and unencoded datasets. With the original data
